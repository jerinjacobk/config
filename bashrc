...
alias mp="mplayer"
alias l="ls -ltr"
alias p="git diff > /tmp/git_diff && ./devtools/checkpatches.sh /tmp/git_diff"
alias pa="sudo pacman"
alias o="cd /export/linux-aarch64/drivers/net/ethernet/cavium/octeontx2"
alias d="cd /export/dpdk-cavium"
alias e="exit"
